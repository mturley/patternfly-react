...
class DataToolbarSpacers extends React.Component {
  ...
  render() {
    const firstSpacers = [{ modifier: 'spacer-none' }];
    const secondSpacers = [{ modifier: 'spacer-sm' }];
    const thirdSpacers = [{ modifier: 'spacer-md' }];
    const fourthSpacers = [{ modifier: 'spacer-lg' }];
    const fifthSpacers = [
    ...
    const spaceItems = [{ modifier: 'space-items-lg' }];

    const items = (
      <React.Fragment>
        <DataToolbarItem breakpointMods={firstSpacers}>
          <Button variant="secondary">Action</Button>
        </DataToolbarItem>
        <DataToolbarItem breakpointMods={secondSpacers}>
          <Button variant="secondary">Action</Button>
        </DataToolbarItem>
        <DataToolbarItem breakpointMods={thirdSpacers}>
          <Button variant="secondary">Action</Button>
        </DataToolbarItem>
        <DataToolbarItem breakpointMods={fourthSpacers}>
          <Button variant="secondary">Action</Button>
        </DataToolbarItem>
        <DataToolbarItem variant="separator"></DataToolbarItem>
        <DataToolbarItem breakpointMods={fifthSpacers}>
          <Button variant="secondary">Action</Button>
        </DataToolbarItem>
        <DataToolbarItem>
          <Button variant="primary">Action</Button>
    ...
    return (
      <DataToolbar id="data-toolbar-spacers">
        <DataToolbarContent>{items}</DataToolbarContent>
      </DataToolbar>
    );
  }
...
class DataToolbarComponentMangedToggleGroup extends React.Component {
  ...
  render() {
    ...
    return (
      <DataToolbar id="data-toolbar-component-managed-toggle-groups">
        <DataToolbarContent>{items}</DataToolbarContent>
      </DataToolbar>
    );
  }
...
class DataToolbarConsumerMangedToggleGroup extends React.Component {
  ...
  render() {
    ...
    return (
      <DataToolbar
        id="data-toolbar-consumer-managed-toggle-groups"
  ...
  render() {
    ...
    return (
      <DataToolbar
        ...
        showClearFiltersButton={filters.risk.length !== 0 || filters.status.length !== 0}
      >
...
class DataToolbarStacked extends React.Component {
  ...
  render() {
    ...
    const toggleGroupItems = (
      <React.Fragment>
        <DataToolbarItem variant="label" id="stacked-example-resource-select">
          Resource
        </DataToolbarItem>
        <DataToolbarItem>
          <Select
        ...
        <DataToolbarItem variant="label" id="stacked-example-status-select">
          Status
        </DataToolbarItem>
        <DataToolbarItem>
          <Select
        ...
        <DataToolbarItem variant="label" id="stacked-example-type-select">
          Type
        </DataToolbarItem>
        <DataToolbarItem>
          <Select
    ...
    const firstRowItems = (
      <React.Fragment>
        ...
        <DataToolbarGroup variant="icon-button-group">{iconButtonGroupItems}</DataToolbarGroup>
        <DataToolbarItem variant="overflow-menu" breakpointMods={[{ modifier: 'align-right' }]}>
          Overflow Menu
        </DataToolbarItem>
      </React.Fragment>
    );
