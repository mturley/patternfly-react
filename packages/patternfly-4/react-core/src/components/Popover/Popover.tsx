        ...
        {randomId => (
          ...
          >
            <div
              ...
              aria-labelledby={
                headerContent ? `popover-${randomId}-header` : undefined
              }
            ...
            >
              <PopoverContent>
                ...
                />
                {headerContent && (
                  <PopoverHeader id={`popover-${randomId}-header`}>
                    {headerContent}
                  </PopoverHeader>
                )}
                <PopoverBody id={`popover-${randomId}-body`}>
                  {bodyContent}
                </PopoverBody>
                {footerContent && (
                  <PopoverFooter>{footerContent}</PopoverFooter>
                )}
              </PopoverContent>
            </div>
          </FocusTrap>
