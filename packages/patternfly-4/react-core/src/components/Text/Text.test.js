  ...
  const view = mount(
    <TextContent>
      ...
      <Text component={TextVariants.p}>
        ...
        semper dui. Fusce erat odio, sollicitudin vel erat vel, interdum mattis neque. Sub works as
        well!
      </Text>
      ...
      <Text component={TextVariants.p}>
        ...
        . Phasellus lacus ex, semper ac tortor nec, fringilla condimentum orci. Fusce eu rutrum
        tellus.
      </Text>
      ...
      <Text component={TextVariants.p}>
        Quisque at semper enim, eu hendrerit odio. Etiam auctor nisl et <em>justo sodales</em>{' '}
        elementum. Maecenas ultrices lacus quis neque consectetur, et lobortis nisi molestie.
      </Text>
      <Text component={TextVariants.p}>
        Sed sagittis enim ac tortor maximus rutrum. Nulla facilisi. Donec mattis vulputate risus in
        luctus. Maecenas vestibulum interdum commodo.
      </Text>
      ...
      <Text component={TextVariants.p}>
        Suspendisse egestas sapien non felis placerat elementum. Morbi tortor nisl, suscipit sed mi
        sit amet, mollis malesuada nulla. Nulla facilisi. Nullam ac erat ante.
      </Text>
      <Text component={TextVariants.h4}>Fourth level</Text>
      <Text component={TextVariants.p}>
        Nulla efficitur eleifend nisi, sit amet bibendum sapien fringilla ac. Mauris euismod metus a
        tellus laoreet, at elementum ex efficitur.
      </Text>
      <Text component={TextVariants.p}>
        Maecenas eleifend sollicitudin dui, faucibus sollicitudin augue cursus non. Ut finibus
      ...
      <Text component={TextVariants.p}>
        Phasellus porttitor enim id metus volutpat ultricies. Ut nisi nunc, blandit sed dapibus at,
      ...
      <Text component={TextVariants.p}>
        Aliquam sagittis rhoncus vulputate. Cras non luctus sem, sed tincidunt ligula. Vestibulum at
      ...
      <Text component={TextVariants.p}>
        Cras in nibh lacinia, venenatis nisi et, auctor urna. Donec pulvinar lacus sed diam
        ...
        maximus dui, sed varius sapien odio vitae est. Etiam at cursus metus.
      </Text>
    </TextContent>
  );
