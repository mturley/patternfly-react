...
describe('EmptyState', () => {
  test('Main', () => {
    const view = shallow(
      <EmptyState>
        ...
        <EmptyStateBody>
          Defining HTTP Proxies that exist on your network allows you to perform various actions
  ...
  test('Secondary Action', () => {
    const view = shallow(
      <EmptyStateSecondaryActions className="custom-empty-state-secondary" id="empty-state-2" />
    );
