...
export interface OptionsMenuToggleWithTextProps
...
export const OptionsMenuToggleWithText: React.FunctionComponent<
...
> = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className={css(styles.optionsMenuToggleText, toggleTextClassName)}>
        {toggleText}
      </span>
      <OptionsMenuToggle
