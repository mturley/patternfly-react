...
export interface ChipGroupToolbarItemProps
...
export const ChipGroupToolbarItem: React.FunctionComponent<
        ...
        {(HeadingLevel: any) => {
          return (
            <ul
              className={css(
                styles.chipGroup,
                styles.modifiers.toolbar,
                className
              )}
              {...props}
            >
              <li>
                <HeadingLevel className={css(styles.chipGroupLabel)}>
                  {categoryName}
                </HeadingLevel>
