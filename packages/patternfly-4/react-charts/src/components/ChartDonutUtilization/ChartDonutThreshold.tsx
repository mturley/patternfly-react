...
export const ChartDonutThreshold: React.FunctionComponent<
...
> = ({
  ...
  legendPosition = ChartCommonStyles.legend
    .position as ChartDonutThresholdLegendPosition,
  padding,
  radius,
  standalone = true,
  subTitlePosition = ChartDonutStyles.label
    .subTitlePosition as ChartDonutThresholdSubTitlePosition,
  themeColor,
  themeVariant,
  x,
  y,
