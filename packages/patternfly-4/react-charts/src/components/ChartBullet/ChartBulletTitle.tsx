...
export const ChartBulletTitle: React.FunctionComponent<
...
> = ({
  ...
  const getTitle = () => {
    ...
    let labelPosition: 'bottom' | 'left' | 'top-left' = horizontal
      ? 'left'
      : 'bottom';
    ...
    return React.cloneElement(titleComponent, {
      ...
      textAnchor:
        labelPosition === 'top-left' ? 'start' : horizontal ? 'end' : 'middle',
