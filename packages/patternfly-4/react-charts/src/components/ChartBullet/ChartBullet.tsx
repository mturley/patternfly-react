...
export const ChartBullet: React.FunctionComponent<ChartBulletProps> = ({
  ...
  const comparativeZeroMeasure = React.cloneElement(
    comparativeZeroMeasureComponent,
    {
  ...
  const primarySegmentedMeasure = React.cloneElement(
    primarySegmentedMeasureComponent,
    {
      constrainToVisibleArea,
  ...
  const axis = React.cloneElement(axisComponent, {
    ...
    offsetX: !horizontal
      ? defaultPadding.left * 0.5 +
        (defaultPadding.right * 0.5 - (defaultPadding.right - 55))
      : 0,
    offsetY: horizontal
      ? 80 - defaultPadding.top * 0.5 + (defaultPadding.bottom * 0.5 - 25)
      : 0,
    padding,
    standalone: false,
