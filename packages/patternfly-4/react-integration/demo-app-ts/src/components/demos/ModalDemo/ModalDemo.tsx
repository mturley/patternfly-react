      ...
      <Modal
        ...
        actions={[
          <Button
            key="cancel"
            variant="secondary"
            onClick={this.handleSmallModalToggle}
          >
            Cancel
          </Button>,
          <Button
      ...
      <Modal
        ...
        actions={[
          <Button
            key="cancel"
            variant="secondary"
            onClick={this.handleLargeModalToggle}
          >
            Cancel
          </Button>,
          <Button
    ...
    const header = (
      <React.Fragment>
        ...
        <p id="customHeaderDescription" className="pf-u-pt-sm">
          Allows for custom content in the header and/or footer by passing
          components.
        </p>
      </React.Fragment>
    );
    ...
    return (
      ...
      >
        <span id="custom-header-example">
          ...
          with an ID referring to the modal's aria-describedby value.
        </span>
        <br />
        <br />
