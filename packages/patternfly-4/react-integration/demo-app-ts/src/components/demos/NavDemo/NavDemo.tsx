...
export class NavDemo extends Component {
  ...
  renderExpandableNav() {
    const {
      expandableActiveGroup,
      expandableActiveItem,
      expandableClickedGroup,
      expandableClickedItem
    } = this.state;
    return (
            ...
            <NavList>
              ...
              >
                <NavItem
                  ...
                  itemId="itm-2-1"
                  isActive={
                    expandableActiveGroup === 'grp-2' &&
                    expandableActiveItem === 'itm-2-1'
                  }
                  onClick={this.handleItemOnclick}
                >
                  Item 1
