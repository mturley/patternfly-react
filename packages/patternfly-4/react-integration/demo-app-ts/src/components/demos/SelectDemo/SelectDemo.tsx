...
export class SelectDemo extends Component<SelectDemoState> {
  ...
  checkboxOptions = [
    ...
    <SelectOption
      key={1}
      value={
        { numericValue: 0, toString: () => 'Cancelled' } as SelectOptionObject
      }
    />,
  ...
  customTypeaheadOptions = [
    ...
    {
      value: new State('North Carolina', 'NC', 'Raleigh', 1789),
      disabled: false
    }
  ];
  ...
  customSelectValueOptions = [
    ...
    <SelectOption
      key={7}
      value={new State('Florida', 'FL', 'Tailahassee', 1845)}
    />,
    <SelectOption
      key={8}
      value={new State('New Jersey', 'NJ', 'Trenton', 1787)}
    />,
    <SelectOption
      key={9}
      value={new State('New Mexico', 'NM', 'Santa Fe', 1912)}
    />,
    <SelectOption
      key={10}
      value={new State('New York', 'NY', 'Albany', 1788)}
    />,
    <SelectOption
      key={11}
      value={new State('North Carolina', 'NC', 'Raleigh', 1789)}
    ...
    if (checkSelected.includes(selection)) {
      this.setState(
        (prevState: SelectDemoState) => ({
          checkSelected: prevState.checkSelected.filter(
            item => item !== selection
          )
        }),
      ...
      this.setState(
        (prevState: SelectDemoState) => ({
          checkSelected: [...prevState.checkSelected, selection]
        }),
        () => console.log('selections: ', this.state.checkSelected)
      );
    }
  ...
  typeaheadMultiOnSelect = (event: any, selection: string | object) => {
    ...
    if (typeaheadMultiSelected.includes(selection)) {
      this.setState(
        (prevState: SelectDemoState) => ({
          typeaheadMultiSelected: prevState.typeaheadMultiSelected.filter(
            item => item !== selection
          )
        }),
      ...
      this.setState(
        (prevState: SelectDemoState) => ({
          typeaheadMultiSelected: [
            ...prevState.typeaheadMultiSelected,
            selection
          ]
        }),
        () => console.log('selections: ', this.state.typeaheadMultiSelected)
  ...
  cdtypeaheadMultiOnSelect = (event: any, selection: string | object) => {
    ...
    if (cdtypeaheadMultiSelected.includes(selection)) {
      this.setState(
        (prevState: SelectDemoState) => ({
          cdtypeaheadMultiSelected: prevState.cdtypeaheadMultiSelected.filter(
            item => item !== selection
          )
        }),
      ...
      this.setState(
        (prevState: SelectDemoState) => ({
          cdtypeaheadMultiSelected: [
            ...prevState.cdtypeaheadMultiSelected,
            selection
          ]
        }),
        () => console.log('selections: ', this.state.cdtypeaheadMultiSelected)
  ...
  plainTypeaheadMultiOnSelect = (event: any, selection: string) => {
    ...
    if (plainTypeaheadMultiSelected.includes(selection)) {
      this.setState(
        (prevState: SelectDemoState) => ({
          plainTypeaheadMultiSelected: prevState.plainTypeaheadMultiSelected.filter(
            item => item !== selection
          )
        }),
        () =>
      ...
      this.setState(
        (prevState: SelectDemoState) => ({
          plainTypeaheadMultiSelected: [
            ...prevState.plainTypeaheadMultiSelected,
            selection
          ]
        }),
        () =>
  ...
  customTypeaheadMultiOnSelect = (event: any, selection: string) => {
    ...
    if (customTypeaheadMultiSelected.includes(selection)) {
      this.setState(
        (prevState: SelectDemoState) => ({
          customTypeaheadMultiSelected: prevState.customTypeaheadMultiSelected.filter(
            item => item !== selection
          )
        }),
        () =>
      ...
      this.setState(
        (prevState: SelectDemoState) => ({
          customTypeaheadMultiSelected: [
            ...prevState.customTypeaheadMultiSelected,
            selection
          ]
        }),
        () =>
      ...
      <StackItem isFilled={false}>
        ...
        <div>
          ...
          <Select
            ...
            onCreateOption={
              (typeaheadNewOptions && this.typeaheadCreateNew) || undefined
            }
