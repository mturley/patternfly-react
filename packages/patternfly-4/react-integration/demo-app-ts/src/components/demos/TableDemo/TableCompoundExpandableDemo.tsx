...
export class TableCompoundExpandableDemo extends React.Component<
  TableProps,
      ...
      rows: [
        {
          ...
          cells: [
            ...
            },
            {
              ...
              props: {
                isOpen: true,
                ariaControls: 'compoound-expansion-table-1'
              }
            },
            {
              title: (
              ...
              props: {
                isOpen: false,
                ariaControls: 'compoound-expansion-table-2'
              }
            },
            {
              title: (
              ...
              props: {
                isOpen: false,
                ariaControls: 'compoound-expansion-table-3'
              }
            },
            '20 minutes',
        ...
        },
        {
          ...
          cells: [
            ...
            },
            {
              ...
              props: {
                isOpen: false,
                ariaControls: 'compoound-expansion-table-4'
              }
            },
            {
              title: (
              ...
              props: {
                isOpen: false,
                ariaControls: 'compoound-expansion-table-5'
              }
            },
            {
              title: (
              ...
              props: {
                isOpen: false,
                ariaControls: 'compoound-expansion-table-6'
              }
            },
            '20 minutes',
            { title: <a href="#">Open in Github</a> }
