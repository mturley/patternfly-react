...
export class ApplicationLauncherDemo extends React.Component<
  null,
  ApplicationLauncherState
> {
    ...
    const dropdownItems = [
      <Tooltip content={<div>Launch Application 1</div>}>
        <DropdownItem
          key="application_1"
          component="a"
          href="http://patternfly-react.surge.sh/"
        >
          Application 1
        </DropdownItem>
      </Tooltip>,
      ...
      <Tooltip
        content={<div>Application Unavailable At This Time</div>}
        position="bottom"
      >
