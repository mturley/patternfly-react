  ...
  render() {
    return (
      <React.Fragment>
        ...
        <EmptyState
          children={this.mySmallEmptyStateProps.children}
          variant={this.mySmallEmptyStateProps.variant}
        />
        <EmptyState
          children={this.myFullEmptyStateProps.children}
          variant={this.myFullEmptyStateProps.variant}
        />
      </React.Fragment>
    );
  }
