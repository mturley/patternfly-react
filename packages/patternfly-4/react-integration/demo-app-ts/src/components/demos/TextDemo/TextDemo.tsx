...
export class TextDemo extends Component {
  ...
  render() {
    return (
      <TextContent>
        <Text component={this.myTextProps.component}>
          {this.myTextProps.children}
        </Text>
        <TextList component={this.myTextListProps.component}>
          <TextListItem
            children={this.myTextListItemProps.children}
            component={this.myTextListItemProps.component}
          />
        </TextList>
      </TextContent>
    );
