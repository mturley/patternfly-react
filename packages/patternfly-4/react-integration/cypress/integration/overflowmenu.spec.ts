describe('OverflowMenu Demo Test', () => {
  ...
  describe('Simple OverflowMenu Medium', () => {
    context('List view', () => {
      ...
      it('displays OverflowMenuContent', () => {
        cy.get('#simple-overflow-menu .pf-c-overflow-menu__content').should(
          'be.visible'
        );
        cy.get('#simple-overflow-menu .pf-c-overflow-menu__control').should(
          'not.be.visible'
        );
      });
    });
    ...
    context('Dropdown view', () => {
      ...
      it('Verify toggle dropdown', () => {
        cy.get('#simple-overflow-menu button').should(
          'have.class',
      ...
      it('Verify dropdown menu expanded', () => {
        cy.get('#simple-overflow-menu button')
          .last()
          .click();
        cy.get('#simple-overflow-menu .pf-c-dropdown').should(
          'have.class',
          'pf-m-expanded'
        );
      });
  ...
  describe('Additional Options OverflowMenu Large', () => {
    ...
    context('Dropdown view', () => {
      ...
      it('displays OverflowMenuControl', () => {
        cy.get(
          '#additional-options-overflow-menu .pf-c-overflow-menu__control'
        ).should('be.visible');
        cy.get(
          '#additional-options-overflow-menu .pf-c-overflow-menu__content'
        ).should('not.be.visible');
      });

      it('Verify toggle dropdown', () => {
        cy.get('#additional-options-overflow-menu button').should(
          'have.class',
          'pf-c-dropdown__toggle'
        );
      });
      ...
      it('Verify dropdown menu expanded', () => {
        cy.get('#additional-options-overflow-menu button')
          .last()
          .click();
        cy.get('#additional-options-overflow-menu .pf-c-dropdown').should(
          'have.class',
          'pf-m-expanded'
        );
      });
  ...
  describe('Persist OverflowMenu X-Large', () => {
    ...
    context('Dropdown view', () => {
      ...
      it('displays OverflowMenuControl and Persistent items', () => {
        cy.get('#persist-overflow-menu .pf-c-overflow-menu__control').should(
          'be.visible'
        );
        cy.get(
      ...
      it('Verify toggle dropdown', () => {
        cy.get('#persist-overflow-menu button').should(
          'have.class',
          'pf-c-dropdown__toggle'
        );
      });
      ...
      it('Verify dropdown menu expanded', () => {
        cy.get('#persist-overflow-menu button')
          .last()
          .click();
        cy.get('#persist-overflow-menu .pf-c-dropdown').should(
          'have.class',
          'pf-m-expanded'
        );
      });
