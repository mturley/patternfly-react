...
import {
  MockTableGridExample,
  MockTableGridExampleSource
} from './_mocks_/mockTableGridExample';
...
const stories = storiesOf(
  `${storybookPackageName(name)}/${STORYBOOK_CATEGORY.CONTENT_VIEWS}/TableGrid`,
  module
);
...
stories.addDecorator(
  defaultTemplate({
    ...
    description: (
      <div>
        The TableGrid is based on the Bootstrap Grid Layout. The{' '}
        <b>TableGrid.ColumnHeaders</b> should have the same bootstrap column
        classes as the children of the <b>TableGrid.Row</b> component in order
        to maintain equal widths.
        <br />
        <br />
        When using <i>cell</i> selection, the <b>TableGrid.Col</b> component
