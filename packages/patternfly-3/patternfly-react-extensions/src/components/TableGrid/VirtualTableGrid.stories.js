...
const stories = storiesOf(
  `${storybookPackageName(name)}/${STORYBOOK_CATEGORY.CONTENT_VIEWS}/VirtualTableGrid`,
  module
);
  ...
  defaultTemplate({
    ...
    description: (
      <div>
        ...
        <a href="https://github.com/bvaughn/react-virtualized">react-virtualized</a> to efficiently
        render large lists of data.
        <br />
        <br />
        The <b>VirtualTableGrid.ColumnHeaders</b> should have the same bootstrap column classes as
        the children of the <b>VirtualTableGrid.Row</b> component in order to maintain equal widths.
        <br />
        <br />
        When using <i>cell</i> selection, the <b>VirtualTableGrid.Col</b> component should be used
        in place of the
