...
const description = (
  <p>
    This component is based on React Bootstrap MenuItem component. This component represents a menu
    item in a dropdown. See{' '}
    <a href={`${DOCUMENTATION_URL.REACT_BOOTSTRAP_COMPONENT}dropdowns/#menu-items`}>
