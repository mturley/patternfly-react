...
const description = (
  <p>
    ...
    <a href={`${DOCUMENTATION_URL.REACT_BOOTSTRAP_COMPONENT}tabs/`}>React Bootstrap Docs</a> for
    complete Tabs component documentation.
  </p>
);
...
stories.add(
  ...
  withInfo()(() => {
    ...
    return [
      <p>
        <b>Note:</b>
        This variation is not keyboard accessible and is not recommended for use where accessibility
        is a priority.
      </p>,
