...
const description = (
  <p>
    This component is based on React Bootstrap Grid component. Grids are used to structure and
    present data. See{' '}
    <a href={`${DOCUMENTATION_URL.REACT_BOOTSTRAP_LAYOUT}grid/`}>React Bootstrap Docs</a> for
    complete Grid component documentation.
  </p>
);
