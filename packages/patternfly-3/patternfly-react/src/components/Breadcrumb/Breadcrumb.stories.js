...
const description = (
  <p>
    This component is based on React Bootstrap Breadcrumb component. Breadcrumbs are used to
    indicate the current page&apos;s location. See{' '}
    <a href={`${DOCUMENTATION_URL.REACT_BOOTSTRAP_COMPONENT}breadcrumb/`}>React Bootstrap Docs</a>{' '}
